...
const DEMO_BULLETS = [
  ...
  'Tailored to your support stack',
  'No commitment required',
  'Most teams are live within 3 days',
]

function ContactDetailsBelowForm() {
  return (
    <div className="mt-10 text-center">
      <div className="mx-auto flex max-w-2xl flex-col items-center gap-10 sm:flex-row sm:items-start sm:justify-center sm:gap-14">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="mt-6 text-xs font-semibold uppercase tracking-widest text-gray-400">Contact us directly</p>
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen px-4 pb-16 pt-24 sm:px-6 lg:px-8" style={{ backgroundColor: '#f5f4f0' }}>
