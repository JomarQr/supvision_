        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_2fr] lg:items-stretch">
          ...
          <div className="flex flex-col justify-between gap-10 rounded-3xl bg-white p-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-gray-400">Contact us directly</p>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="pt-1">
                      ...
                      >
                        ...
                        <span className="relative z-10 tracking-widest uppercase">Book a Demo</span>
