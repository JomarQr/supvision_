...
const data = {
  ...
  points: [
    ...
    { icon: '📂', title: 'Query-type routing', desc: 'Route different query types to different teams. Verification disputes go to compliance. Fraud flags go to the fraud team. Complex account queries go to senior support.' },
