...
const data = {
  ...
  points: [
    ...
    { icon: '✈️', title: 'Telegram', desc: 'Particularly relevant for Web3 fintechs. The agent handles Telegram queries with the same capabilities as every other channel.' },
