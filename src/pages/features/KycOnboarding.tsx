...
const data = {
  badge: 'Support Agent · KYC & Onboarding',
  title: 'KYC & Onboarding',
  subtitle: 'Automate identity verification and onboarding flows.',
  description: 'KYC is the most common source of support tickets in fintech — and the most repetitive. supVision\'s Support Agent resolves verification status queries, explains document rejections, and guides users through re-submission without a human agent involved. Every interaction is logged and audit-ready.',
  points: [
    { icon: '🪪', title: 'Verification status queries', desc: 'Instantly tells users where they are in the KYC process, what is missing, and what to do next — pulling real-time status from your KYC provider.' },
    ...
    { icon: '📋', title: 'Audit-ready decision logs', desc: 'Every KYC-related conversation is logged with the data retrieved, the response given, and the outcome — exportable for regulatory review.' },
  ],
  steps: [
    { step: '01', title: 'User submits query', desc: 'The user asks about their KYC status, a rejection, or a missing step — via chat, email, WhatsApp, or Telegram.' },
    { step: '02', title: 'Agent reads live KYC data', desc: 'Pulls the current verification status, rejection codes, and pending documents directly from your KYC provider API.' },
  ...
  ctaTitle: 'Stop losing users at KYC.',
  ctaDesc: 'Automate verification support and cut KYC-related ticket volume by up to 80%.',
}

const faq = [
  { q: 'Which KYC providers does supVision integrate with?', a: 'Sumsub, Jumio, Onfido, and Veriff out of the box. Any KYC provider with a REST API can be connected during onboarding.' },
  { q: 'Can the agent re-trigger a KYC check?', a: 'Yes, if you grant the agent write access to your KYC provider. By default it operates in read-only mode — escalating re-submission actions to your team or guiding the user to complete them manually.' },
  { q: 'Does the agent handle video KYC queries?', a: 'Yes. It can explain the video KYC process, communicate scheduling options if you use live video verification, and handle failed session queries.' },
