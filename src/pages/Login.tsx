  ...
  return (
    <section className="relative flex min-h-screen flex-col px-4 sm:px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 blue-gradient-hero">
        <svg className="hero-wave-track-4 absolute top-0 left-0 h-full" style={{ width: '200%', filter: 'drop-shadow(0 18px 16px rgba(4,10,48,0.55))' }} viewBox="0 0 5760 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="hero-wave-track-3 absolute top-0 left-0 h-full" style={{ width: '200%', filter: 'drop-shadow(0 18px 16px rgba(4,10,48,0.55))' }} viewBox="0 0 5760 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="hero-wave-track-2 absolute top-0 left-0 h-full" style={{ width: '200%', filter: 'drop-shadow(0 18px 16px rgba(4,10,48,0.55))' }} viewBox="0 0 5760 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="hero-wave-track absolute top-0 left-0 h-full" style={{ width: '200%', filter: 'drop-shadow(0 18px 16px rgba(4,10,48,0.5))' }} viewBox="0 0 5760 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
