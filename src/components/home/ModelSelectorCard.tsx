...
const PROVIDER_ICONS: Record<string, ReactNode> = {
  ...
  anthropic: (
    <svg viewBox="0 0 24 24" className="h-5 w-5 flex-shrink-0" fill="currentColor">
      <path d="M17.304 3.541 13.766 13.24H20.8L17.304 3.541zM6.696 3.541 3.2 13.24h7.033L6.696 3.541zM3.2 13.24l3.496 7.219L9.907 13.24H3.2zm10.566 0 3.211 7.219L20.8 13.24h-7.034zM9.907 13.24l2.085 4.26 2.085-4.26H9.907z" />
    </svg>
  ),
  google: (
  ...
  perplexity: (
    <svg viewBox="0 0 24 24" className="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 3L4 7v10l8 4 8-4V7L12 3z" />
