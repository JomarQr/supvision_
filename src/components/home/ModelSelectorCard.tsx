...
const PROVIDER_ICONS: Record<string, ReactNode> = {
  ...
  anthropic: <img src="/antchropic.webp" alt="Anthropic" className="h-5 w-5 flex-shrink-0 object-contain" />,
  google: <img src="/google studio.webp" alt="Google AI Studio" className="h-5 w-5 flex-shrink-0 object-contain" />,
  perplexity: <img src="/perplexity.webp" alt="Perplexity" className="h-5 w-5 flex-shrink-0 object-contain" />,
}
