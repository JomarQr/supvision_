...
export const MODEL_ANIM_STEPS: ModelAnimStep[] = [
  ...
  { cx: '28%', cy: 110, ep: 'OpenAI', sm: { p: 'Google AI Studio', m: 'Gemini 2.5 Flash', ik: 'google' }, hm: null, delay: 800 },
  { cx: '42%', cy: 150, ep: 'OpenAI', sm: { p: 'Google AI Studio', m: 'Gemini 2.5 Flash', ik: 'google' }, hm: null, delay: 1000 },
  { cx: '42%', cy: 150, ep: 'OpenAI', sm: { p: 'Google AI Studio', m: 'Gemini 2.5 Flash', ik: 'google' }, hm: 'GPT-5 mini', delay: 420 },
