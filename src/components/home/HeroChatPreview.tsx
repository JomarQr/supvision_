  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: messagesHeight, fontFamily: "'Roboto', sans-serif" }}
      >
        {isDesktop ? (
          <>
            {chatStep >= 1 && (
              <div className={`flex items-end ${gap}`} style={{ animation: 'feature-text-in 0.3s ease both' }}>
                <img src="/avatar.webp" alt="" className={`${avatarSize} mb-0.5 flex-shrink-0 rounded-full object-cover`} />
                ...
                <div className="relative">
                  ...
                  {chatStep >= 3 && (
                    ...
                    >
                      ...
                      <img src="/Component 187 (1).webp" alt="" className={`${reactionAvatar} rounded-full object-cover`} />
                    </div>
                  )}
                </div>
              </div>
            ...
            {chatStep >= 6 && (
              <div className={`mt-1 flex items-end justify-end ${gap}`} style={{ animation: 'feature-text-in 0.3s ease both' }}>
                ...
                <img src="/Component 187 (1).webp" alt="" className={`${avatarSize} mb-0.5 flex-shrink-0 rounded-full object-cover`} />
              </div>
            )}
            {chatStep >= 8 && (
      ...
      <div className={`flex items-center border-t border-white/10 px-3 ${isDesktop ? 'gap-2.5 py-3.5' : 'gap-2 py-3'}`}>
        <img src="/Component 187 (1).webp" alt="" className={`${avatarSize} flex-shrink-0 rounded-full object-cover`} />
        <div
